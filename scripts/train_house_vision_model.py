"""CLI entrypoint for the reviewed house-only multi-task CNN training run."""
...
from lesotho_property_ai.vision.training import train_house_vision_model
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train the house-only vision model on the curated image dataset."
    )
    parser.add_argument(
        "--input-csv",
        default=None,
...
def main() -> None:
    ...
    result = train_house_vision_model(
    ...
    print("House vision training complete")
